...
<template>
  <div class="xtx-cart-page">
    <div class="container m-top-20">
        ...
        <table>
          ...
          <tbody>
            <tr v-for="i in cartStore.cartList" :key="i.id">
              ...
              <td class="tc">
                <p>
                  <el-popconfirm title="确认删除吗?" confirm-button-text="确认" cancel-button-text="取消" @confirm="cartStore.cartdelate(i)">
                    <template #reference>
      ...
      <div class="action">
        <div class="batch">
          共 {{cartStore.allCount}} 件商品，已选择 {{cartStore.isNeed}} 件，商品合计：
          <span class="red">¥ {{cartStore.needPrice}}.00 </span>
        </div>
        <div class="total">
